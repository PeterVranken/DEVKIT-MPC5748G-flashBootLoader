...
ifneq ($(useFlatObjectFileStructure),)
    ...
    # Use source file path designation for object files, too.
...
ifneq ($(useFlatObjectFileStructure),)
# Blank separated search path for source files and their prerequisites are required if we
...
# rely on searching the files.
    ...
    ifneq ($(pathFromCommonParentToProject),)
        VPATH := $(commonParentOfAllSourcePaths)
    endif
endif
#$(info VPATH: $(VPATH))
