...
communicate with the application, demand reset 3, and can then start the
CCP communication with the meanwhile started FBL for re-programming the
application. The entire process "Update firmware" appears to the user as a
