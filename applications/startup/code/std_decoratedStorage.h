...
/**
 * The basic operations for implenting mutual exclusion typically require a memory barrier.
 * We offer a full barrier, which may sometimes be too strong but is simple, safe and
